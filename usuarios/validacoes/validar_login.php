...
if (!empty($senha) && !empty($usuario)) {
	...
	$sql="SELECT u.cod_usuario, u.nome_usuario, n.cod_nivel, u.ativo_usuario, n.ativo_nivel, u.t_nivel_cod_nivel FROM t_usuario u JOIN t_nivel n ON (u.t_nivel_cod_nivel=n.cod_nivel) WHERE login_usuario='$usuario' AND senha_usuario='$csenha'";

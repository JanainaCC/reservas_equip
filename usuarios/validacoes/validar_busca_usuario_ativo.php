...
<body >
	...
	<div id="dominio">Usuários Encontrados</div>
	<div id="logo_usuario"><a href="../../inicio.php"><img src="../../imagens/logo.png"></a></div>	

	<?php

	$sql="SELECT u.nome_usuario, u.login_usuario, u.data_cadastro, u.usu_cadastro, n.cod_nivel, n.nome_nivel FROM t_usuario u JOIN t_nivel n ON (u.t_nivel_cod_nivel = n.cod_nivel) WHERE u.nome_usuario LIKE '$usuario%' AND u.ativo_usuario ='1'";
	...
	<div id="voltar"> <a href="../usuarios.php">Voltar</a></div> 

...
<body >
	...
	<div id="dominio">Exibir Usuários Inativos</div>
	...
	$sql="SELECT u.nome_usuario, u.login_usuario, u.data_cadastro, u.usu_cadastro, n.cod_nivel, n.nome_nivel FROM t_usuario u JOIN t_nivel n ON (u.t_nivel_cod_nivel = n.cod_nivel) WHERE u.ativo_usuario='0'";
	...
	if (!$result) {
		...
		}	$_SESSION['$usuariosInativos']=$usuarios; ?>
		<div id="tabela">

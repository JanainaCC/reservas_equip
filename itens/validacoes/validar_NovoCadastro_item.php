...
if (!empty($codigo) && !empty($descricao)) {
	...
	$sql="INSERT INTO t_item(cod_item, t_tipo, descricao_item, valor_item, conteudo_item, obs_item, data_cadastro, usuario_cadastro) VALUES('$codigo', '$tipo','$descricao', '$valor', '$conteudo', '$obs', '$data_cadastro', '$usuario_cadastro');";
